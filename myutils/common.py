...
def melt_model_masks(model):
    #print("=> Melting model mask")
    for n, m in model.named_modules():
        if hasattr(m, "mask") and m.mask is not None:
            #print(f"==> Own gradient to {n}.mask")
...
def melt_model_weights(model):
    #print("=> Melting model weights")
    for n, m in model.named_modules():
        if hasattr(m, "weight") and m.weight is not None:
            #print(f"==> Own gradient to {n}.weight")
            ...
            if hasattr(m, "bias") and m.bias is not None:
                #print(f"==> Own gradient to {n}.bias")
